...
def main():
    ...
    parser.add_argument("--csv", type=Path, default=Path("../BENCMARK_DATASETS/meld_erc.csv"))
    parser.add_argument("--root", type=Path, default=Path("/Users/yusuf/Data/MELD.Raw"))
    parser.add_argument("--out", type=Path, default=Path("../BENCMARK_DATASETS/meld_erc_acoustic_features.csv"))
