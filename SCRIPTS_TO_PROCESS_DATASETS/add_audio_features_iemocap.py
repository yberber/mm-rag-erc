...
def main():
    ...
    parser.add_argument("--csv", type=Path, default=Path("../BENCMARK_DATASETS/iemocap_erc.csv"))
    parser.add_argument("--root", type=Path, default=Path("/Users/yusuf/Data/IEMOCAP_full_release"))
    parser.add_argument("--out", type=Path, default=Path("../BENCMARK_DATASETS/iemocap_erc_acoustic_features.csv"))
